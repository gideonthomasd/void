...
sudo xbps-install font-iosevka plank xcompmgr feh firefox geany pcmanfm Thunar thunar-volman thunar-archive-plugin xarchiver unzip xdo base-devel arandr lxsession lxappearance git dmenu rofi neofetch xterm 
...
sudo xbps-install xfce4-appfinder blueman xfce4-terminal polybar timeshift base-devel libX11-devel libXft-devel libXinerama-devel noto-fonts-ttf rofi nano vim bumblebee-status bspwm curl gsimplecal-gtk2 sabnzbd
